...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('aluno-sim').addEventListener('change', toggleMatriculaField);
  document.getElementById('aluno-nao').addEventListener('change', toggleMatriculaField);
});
